              ...
              <div className="-space-y-px rounded-md shadow-sm">
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="relative block w-full appearance-none rounded-none border-green-400 px-3 py-2 text-slate-300 placeholder-slate-400 focus:z-10 focus:border-green-700 focus:outline-none focus:ring-green-700 sm:text-sm bg-slate-900"
              ...
              <div>
                ...
                >
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                    <LockClosedIcon
                      className="h-5 w-5 text-black group-hover:text-slate-800"
                      aria-hidden="true"
                    />
                  </span>
                  Login
